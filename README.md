...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-03 23:41`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/722223ad-797b-4b2d-8b40-cbc816408edb.git
$ cd 722223ad-797b-4b2d-8b40-cbc816408edb
```
